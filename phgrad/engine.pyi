...
class Tensor:
    ...
    def __mul__(self, other: typing.Union[phgrad.engine.Tensor, float, int]) -> Tensor: ...
    def __neg__(self): ...
    def __radd__(self, other: typing.Union[phgrad.engine.Tensor, float, int]) -> Tensor: ...
    def __repr__(self) -> str: ...
    def __rmul__(self, other: typing.Union[phgrad.engine.Tensor, float, int]) -> Tensor: ...
    def __rsub__(self, other: typing.Union[phgrad.engine.Tensor, float, int]) -> Tensor: ...
    def __setitem__(self, idx, value): ...
    def __str__(self) -> str: ...
    def __sub__(self, other: typing.Union[phgrad.engine.Tensor, float, int]) -> Tensor: ...
